(function() {
    ...
    * @returns {string} json
    */
    ImageHeightMap.prototype.exports = function(){
        var ex = {};
    ...
    * @returns {void}
    */
    ImageHeightMap.prototype.imports = function(json){
        try{
        ...
        if(typeof imp.options === 'undefined' || typeof imp.grid === 'undefined'){
            console.error('Invalid IsomerHeightMap data.');
            return;
        }
    ...
    window.ImageHeightMap = ImageHeightMap;
